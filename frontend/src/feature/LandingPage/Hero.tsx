  ...
  return (
   <div className="flex flex-col items-center w-full">
    <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
      {/* hero */}
      <Wrapper>
        <div className="absolute inset-0 dark:bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[linear-gradient(to_right,#161616_1px,transparent_1px),linear-gradient(to_bottom,#161616_1px,transparent_1px)] bg-[size:4rem_4rem]  z[-10] h-[150vh]" />
       ...
       <Wrapper className="flex flex-col items-center justify-center py-12 relative">
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                          Zaplog offers you ease of reading and writing blogs using AI 
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            {/* testimonials */}
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                <div className="hidden md:block absolute -top-1/4 -left-1/3 w-72 h-72 bg-indigo-500 rounded-full blur-[10rem] -z-9"></div>
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            See how Zaplog empowers businesses of all sizes. Here&apos;s what real people are saying on Twitter
                        </p>
                    </div>
                </Container>
                <Container>
                    ...
                    <LampContainer>
                        <div className="flex flex-col items-center justify-center relative w-full text-center ">
                            ...
                            <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                                Build stunning websites with Zaplog&apos;s intuitive drag-and-drop builder and powerful AI assistant
                            </p>
